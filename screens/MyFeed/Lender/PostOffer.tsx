      ...
      <View
        ...
        <PostOfferHeader
          ...
          participants={[
            {
              name: 'John Doe',
              avatarUri: 'https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZmFjZXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
            },
            {
              name: 'John Doe',
              avatarUri: 'https://images.unsplash.com/photo-1601288496920-b6154fe3626a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZmFjZXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
            },
            { name: 'John Doe', avatarUri: 'http://example.com/johndoe.png' },
            // ... other participants
          ]}
          buttonText="Offer" interestPercentage={0}        />
      </View>
    </View>
  );
}
